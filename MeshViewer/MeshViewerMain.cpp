...
MeshViewerMain::MeshViewerMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void MeshViewerMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Обновляет состояние приложения один раз за кадр.
void MeshViewerMain::Update() 
{
	ProcessInput();
...
void MeshViewerMain::ProcessInput()
{
...
void MeshViewerMain::OnDeviceLost()
{
...
void MeshViewerMain::OnDeviceRestored()
{
